                        ...
                        @if(count($category->child) > 0)
                            ...
                            <li class="widget__categories--menu__list">
                                ...
                                <label class="widget__categories--menu__label d-flex align-items-center">
                                    ...
                                    <span class="widget__categories--menu__text">{{ __translate($category->title, $category->bn_title) }}</span>
                                    ...
                                    @foreach($category->child as $p_category)
                                        ...
                                        <li class="widget__categories--menu__list ms-2 me-1">
                                            ...
                                            <label class="widget__categories--menu__label d-flex align-items-center">
                                                ...
                                                <span class="widget__categories--menu__text">{{ __translate($p_category->title, $p_category->bn_title) }}</span>
                                                <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                    <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                                </svg>
                                            </label>
                                                ...
                                                <li class="widget__categories--sub__menu--list ms-2">
                                                    <a class="widget__categories--sub__menu--link d-flex align-items-center" href="{{route('products', ['category_id'=>$inner_sub_category->id])}}">
                                                        ...
                                                        <span class="widget__categories--sub__menu--text">
                                                            {{ __translate($inner_sub_category->title, $inner_sub_category->bn_title) }}
                                                        </span>
                                                    </a>
                                                </li>
                                                @endforeach
                                        ...
                                        @else
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="{{route('products', ['category_id'=>$p_category->id])}}">
                                                    ...
                                                    <span class="widget__categories--sub__menu--text">{{ __translate($p_category->title, $p_category->bn_title) }}</span>
                                                </a>
                                            </li>
                                        @endif
                                    @endforeach
                            ...
                            <li class="widget__categories--sub__menu--list">
                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="{{route('products', ['category_id'=>$category->id])}}">
                                    ...
                                    <span class="widget__categories--sub__menu--text">{{ __translate($category->title, $category->bn_title) }}</span>
                                </a>
                            </li>
                        @endif
                    @endforeach
            ...
            <div class="single__widget widget__bg">
                ...
                <ul class="widget__form--check">
                    ...
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="brand_{{$brand->id}}">
                            {{ __translate($brand->title, $brand->bn_title) }}
                        </label>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4">
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block" id="desktop_filter">
                        ...
                        <div class="single__widget widget__bg">
                            <h2 class="widget__title h3 mb-1">{{ __('messages.Brands') }}</h2>
                            <ul class="widget__form--check">
                                @foreach($brands as $brand)
                                <li class="widget__form--check__list">
                                    <label class="widget__form--check__label" for="brand_{{$brand->id}}">
                        ...
                        <div class="tab_content">
                            <div id="product_grid" class="tab_pane active show">
                                <div class="product__section--inner product__grid--inner">
                                    <div class="row row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-1 mb--n30" id="product_body">
